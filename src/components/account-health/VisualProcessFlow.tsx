...
export const VisualProcessFlow = () => {
  ...
  return <section id="how-it-works" className="bg-card py-24">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12 relative">
          ...
          return <div key={index} className="relative">
                ...
                <div className="text-center space-y-4">
                  ...
                  {/* Expandable Section */}
                  <button onClick={() => toggleStep(index)} className="group relative inline-flex items-center gap-2 px-4 py-2 mt-4 rounded-lg bg-primary/5 hover:bg-primary/10 text-primary font-medium transition-all duration-300 hover:shadow-md">
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isExpanded ? 'max-h-[600px] opacity-100 mt-6' : 'max-h-0 opacity-0 mt-0'}`}>
                    <div className="relative bg-gradient-to-br from-primary/5 to-blue-500/5 border border-primary/20 p-6 rounded-xl text-left shadow-lg">
                      ...
                      {index === 1 && <div className="flex flex-wrap gap-3 mt-4 pl-3">
