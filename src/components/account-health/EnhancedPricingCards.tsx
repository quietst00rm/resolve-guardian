...
export const EnhancedPricingCards = () => {
  ...
  return (
    <section id="pricing-tiers" className="bg-background py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-8">
          {tiers.map((tier, index) => (
            <div
              key={index}
              className={`relative bg-card rounded-2xl p-8 transition-all duration-300 hover:scale-105 ${
                tier.popular 
            ...
            >
              {/* Most Popular Badge */}
              {tier.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-primary text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg whitespace-nowrap">
                  MOST POPULAR - 70% of clients choose this tier
                </div>
              )}
              ...
              {/* CTA Button */}
              <Button 
                className={`w-full py-6 text-base font-semibold h-auto ${
                  tier.popular 
                    ? 'bg-primary hover:bg-blue-700 text-white' 
                    : 'bg-secondary hover:bg-opacity-90 text-secondary-foreground'
                }`}
              >
                {tier.cta}
              </Button>
          ...
          <div className="overflow-x-auto animate-fade-in">
            <table className="w-full bg-card rounded-xl overflow-hidden shadow-lg">
              ...
              <tbody className="text-sm">
                {[
                  { feature: "Daily Monitoring", essential: "✓", complete: "✓", unlimited: "✓" },
                  { feature: "Violations/Month", essential: "15", complete: "35", unlimited: "60" },
                  { feature: "POA Drafting", essential: "✓", complete: "✓", unlimited: "✓" },
                  { feature: "POA Submission", essential: "✓", complete: "✓", unlimited: "✓" },
                  { feature: "Response Time", essential: "24hrs", complete: "24hrs", unlimited: "24hrs" },
                  { feature: "Compliance Audits", essential: "—", complete: "Quarterly", unlimited: "Bi-annual" },
                  { feature: "Account Manager", essential: "—", complete: "✓", unlimited: "✓" },
                  { feature: "Phone/Video Support", essential: "—", complete: "✓", unlimited: "✓" },
                  { feature: "Strategy Calls", essential: "—", complete: "—", unlimited: "Monthly" },
                ].map((row, index) => (
