    ...
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-4">See exactly what's included in each protection tier</p>
          <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
            ...
            <span>
              Your tier is determined by our 12-factor risk assessment. Higher risk accounts receive more intensive
              monitoring and support to prevent suspensions.
            </span>
          </div>
        </div>
              ...
              <div key={tier} className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                >
                  <div className="text-left">
                    ...
                    <p className="text-blue-100 mt-1">${prices[tier].toLocaleString()}/month</p>
                  </div>
                  <ArrowRight
                ...
                {isExpanded && (
                  <div className="p-6 space-y-4">
                    {categories.map((category, catIdx) => {
                      ...
                      return (
                        <div key={catIdx}>
                          <h4 className="font-bold text-gray-900 mb-3 text-sm uppercase tracking-wide">{category}</h4>
